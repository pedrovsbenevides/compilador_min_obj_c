...
/* Onde: ID: Identificador, PR: Palavra Reservada; SN: Sinal; CT_*: Constante numérica ou caracter, LT: cadeia de caracter, OP_ARIT: Operador Aritmético, OP_LOGIC: Operador logico  */
